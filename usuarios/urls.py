...
from .views import CadastroUsuarioView, StudentFormView, TeacherFormView, LoginRedirectView, StudentFormView, ProfileUpdateTemplateView
...
urlpatterns = [
    ...
    path('account/', ProfileUpdateTemplateView.as_view(), name='account')
]